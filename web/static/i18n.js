...
const TRANSLATIONS = {
  fr: {
    ...
    'bm.clear':              'Tout effacer',
    'bm.clear.title':        'Effacer tous les marque-pages',
    'bm.clear.desc':         'Cette action supprimera définitivement tous vos marque-pages, dossiers et tags. Elle est irréversible.',
    'bm.clear.confirm.label':'Tapez DELETE pour confirmer',
    'bm.clear.btn':          'Supprimer tous les marque-pages',
    'folder.new':            '+ Dossier',
    'folder.new.sub':        '+ Sous-dossier',
    'folder.rename':         'Renommer',
    'folder.delete':         'Supprimer le dossier',
    'folder.prompt.name':    'Nom du dossier :',
    'folder.prompt.rename':  'Nouveau nom :',
    ...
    'bm.hidden.label':       'Caché (exclu de la recherche)',
    'bm.hidden.badge':       'Caché',
    'bm.prev':               '← Précédent',
    'bm.next':               'Suivant →',
    ...
    'footer.source':         'Code source (AGPL-3.0)',
  ...
  en: {
    ...
    'bm.clear':              'Clear all',
    'bm.clear.title':        'Clear all bookmarks',
    'bm.clear.desc':         'This will permanently delete all your bookmarks, folders, and tags. This action cannot be undone.',
    'bm.clear.confirm.label':'Type DELETE to confirm',
    'bm.clear.btn':          'Delete all bookmarks',
    'folder.new':            '+ Folder',
    'folder.new.sub':        '+ Sub-folder',
    'folder.rename':         'Rename',
    'folder.delete':         'Delete folder',
    'folder.prompt.name':    'Folder name:',
    'folder.prompt.rename':  'New name:',
    ...
    'bm.hidden.label':       'Hidden (excluded from search)',
    'bm.hidden.badge':       'Hidden',
    'bm.prev':               '← Previous',
    'bm.next':               'Next →',
    ...
    'footer.source':         'Source code (AGPL-3.0)',
